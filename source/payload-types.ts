...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "TwoSideWithContent".
 */
export interface TwoSideWithContent {
  twoSideTitle: string;
  twoSideDescription: string;
  populateBy?: ('collection' | 'selection') | null;
  relationTo?: 'products' | null;
  categories?: (number | Category)[] | null;
  limit?: number | null;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "TwoSideWithContent_select".
 */
export interface TwoSideWithContentSelect<T extends boolean = true> {
  twoSideTitle?: T;
  twoSideDescription?: T;
  populateBy?: T;
  relationTo?: T;
  categories?: T;
  limit?: T;
