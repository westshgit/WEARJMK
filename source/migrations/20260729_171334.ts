...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  await db.run(sql`CREATE TABLE \`pages_blocks_cta_whatsapp_links\` (
  	\`_order\` integer NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_cta_whatsapp_links_order_idx\` ON \`pages_blocks_cta_whatsapp_links\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_cta_whatsapp_links_parent_id_idx\` ON \`pages_blocks_cta_whatsapp_links\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_cta\` (
  	...
  	\`heading\` text,
  	\`subheading\` text,
  	\`email_email_heading\` text,
  	\`email_email_subheading\` text,
  	\`block_name\` text,
  ...
  await db.run(sql`CREATE TABLE \`pages_blocks_policy_policies\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`icon\` text DEFAULT 'RotateCcw',
  	\`title\` text,
  	\`description\` text,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`pages_blocks_policy\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_policy_policies_order_idx\` ON \`pages_blocks_policy_policies\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_policy_policies_parent_id_idx\` ON \`pages_blocks_policy_policies\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_policy\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_policy_order_idx\` ON \`pages_blocks_policy\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_policy_parent_id_idx\` ON \`pages_blocks_policy\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_policy_path_idx\` ON \`pages_blocks_policy\` (\`_path\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_showcase\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`show_case_title\` text,
  	\`show_case_description\` text,
  	\`populate_by\` text DEFAULT 'collection',
  	\`relation_to\` text DEFAULT 'products',
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_showcase_order_idx\` ON \`pages_blocks_showcase\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_showcase_parent_id_idx\` ON \`pages_blocks_showcase\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_showcase_path_idx\` ON \`pages_blocks_showcase\` (\`_path\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_two_side_with_content\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`two_side_title\` text,
  	\`two_side_description\` text,
  	\`populate_by\` text DEFAULT 'collection',
  	\`relation_to\` text DEFAULT 'products',
  	\`limit\` numeric DEFAULT 10,
  	\`populated_docs_total\` numeric,
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_two_side_with_content_order_idx\` ON \`pages_blocks_two_side_with_content\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_two_side_with_content_parent_id_idx\` ON \`pages_blocks_two_side_with_content\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_two_side_with_content_path_idx\` ON \`pages_blocks_two_side_with_content\` (\`_path\`);`)
  ...
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_cta_whatsapp_links\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`link_type\` text DEFAULT 'reference',
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_cta_whatsapp_links_order_idx\` ON \`_pages_v_blocks_cta_whatsapp_links\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_cta_whatsapp_links_parent_id_idx\` ON \`_pages_v_blocks_cta_whatsapp_links\` (\`_parent_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_policy_policies\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`icon\` text DEFAULT 'RotateCcw',
  	...
  	\`description\` text,
  	\`_uuid\` text,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`_pages_v_blocks_policy\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_policy_policies_order_idx\` ON \`_pages_v_blocks_policy_policies\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_policy_policies_parent_id_idx\` ON \`_pages_v_blocks_policy_policies\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_policy\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_policy_order_idx\` ON \`_pages_v_blocks_policy\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_policy_parent_id_idx\` ON \`_pages_v_blocks_policy\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_policy_path_idx\` ON \`_pages_v_blocks_policy\` (\`_path\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_showcase\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_showcase_order_idx\` ON \`_pages_v_blocks_showcase\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_showcase_parent_id_idx\` ON \`_pages_v_blocks_showcase\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_showcase_path_idx\` ON \`_pages_v_blocks_showcase\` (\`_path\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_two_side_with_content\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_two_side_with_content_order_idx\` ON \`_pages_v_blocks_two_side_with_content\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_two_side_with_content_parent_id_idx\` ON \`_pages_v_blocks_two_side_with_content\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_two_side_with_content_path_idx\` ON \`_pages_v_blocks_two_side_with_content\` (\`_path\`);`)
  ...
  await db.run(sql`CREATE TABLE \`products_product_information\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`info\` text,
  ...
  `)
  await db.run(sql`CREATE INDEX \`products_product_information_order_idx\` ON \`products_product_information\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`products_product_information_parent_id_idx\` ON \`products_product_information\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`products_core_instructions\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`info\` text,
  ...
  `)
  await db.run(sql`CREATE INDEX \`products_core_instructions_order_idx\` ON \`products_core_instructions\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`products_core_instructions_parent_id_idx\` ON \`products_core_instructions\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`products_size_charts\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`size\` text,
  ...
  `)
  await db.run(sql`CREATE INDEX \`products_size_charts_order_idx\` ON \`products_size_charts\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`products_size_charts_parent_id_idx\` ON \`products_size_charts\` (\`_parent_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`_products_v_version_product_information\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`info\` text,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_products_v_version_product_information_order_idx\` ON \`_products_v_version_product_information\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_products_v_version_product_information_parent_id_idx\` ON \`_products_v_version_product_information\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`_products_v_version_core_instructions\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`info\` text,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_products_v_version_core_instructions_order_idx\` ON \`_products_v_version_core_instructions\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_products_v_version_core_instructions_parent_id_idx\` ON \`_products_v_version_core_instructions\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`_products_v_version_size_charts\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`size\` text,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_products_v_version_size_charts_order_idx\` ON \`_products_v_version_size_charts\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_products_v_version_size_charts_parent_id_idx\` ON \`_products_v_version_size_charts\` (\`_parent_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`_products_v\` (
  	...
  	\`parent_id\` integer,
  	\`version_title\` text,
  	\`version_product_description\` text,
  	\`version_inventory\` numeric DEFAULT 0,
  ...
  await db.run(sql`CREATE TABLE \`orders\` (
  	...
  	\`shipping_address_country\` text DEFAULT 'NG',
  ...
  await db.run(sql`CREATE UNIQUE INDEX \`orders_payment_reference_idx\` ON \`orders\` (\`payment_reference\`);`)
  ...
  await db.run(sql`CREATE TABLE \`transactions\` (
  	...
  	\`billing_address_country\` text DEFAULT 'NG',
  ...
  `)
  await db.run(sql`CREATE UNIQUE INDEX \`transactions_paystack_paystack_reference_idx\` ON \`transactions\` (\`paystack_reference\`);`)
  ...
  await db.run(sql`CREATE TABLE \`footer_nav_items_items\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`link_type\` text DEFAULT 'reference',
  ...
  `)
  await db.run(sql`CREATE INDEX \`footer_nav_items_items_order_idx\` ON \`footer_nav_items_items\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`footer_nav_items_items_parent_id_idx\` ON \`footer_nav_items_items\` (\`_parent_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`footer_blocks_carousel\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`footer_blocks_carousel_order_idx\` ON \`footer_blocks_carousel\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`footer_blocks_carousel_parent_id_idx\` ON \`footer_blocks_carousel\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`footer_blocks_carousel_path_idx\` ON \`footer_blocks_carousel\` (\`_path\`);`)
  await db.run(sql`CREATE TABLE \`footer_locations_address_phone_numbers\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`phone_number\` text NOT NULL,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`footer_locations\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`footer_locations_address_phone_numbers_order_idx\` ON \`footer_locations_address_phone_numbers\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`footer_locations_address_phone_numbers_parent_id_idx\` ON \`footer_locations_address_phone_numbers\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`footer_locations_hours\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`day\` text NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`footer_locations_hours_order_idx\` ON \`footer_locations_hours\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`footer_locations_hours_parent_id_idx\` ON \`footer_locations_hours\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`footer_locations\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`name\` text NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`footer_locations_order_idx\` ON \`footer_locations\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`footer_locations_parent_id_idx\` ON \`footer_locations\` (\`_parent_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`social_social_links\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`link_type\` text DEFAULT 'reference',
  	...
  	\`link_url\` text,
  	\`link_label\` text NOT NULL,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`social\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`social_social_links_order_idx\` ON \`social_social_links\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`social_social_links_parent_id_idx\` ON \`social_social_links\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`social\` (
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`updated_at\` text,
  	\`created_at\` text
  );
  `)
  await db.run(sql`CREATE TABLE \`social_rels\` (
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`order\` integer,
  	\`parent_id\` integer NOT NULL,
  	\`path\` text NOT NULL,
  	\`pages_id\` integer,
  	FOREIGN KEY (\`parent_id\`) REFERENCES \`social\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`pages_id\`) REFERENCES \`pages\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`social_rels_order_idx\` ON \`social_rels\` (\`order\`);`)
  await db.run(sql`CREATE INDEX \`social_rels_parent_idx\` ON \`social_rels\` (\`parent_id\`);`)
  await db.run(sql`CREATE INDEX \`social_rels_path_idx\` ON \`social_rels\` (\`path\`);`)
  await db.run(sql`CREATE INDEX \`social_rels_pages_id_idx\` ON \`social_rels\` (\`pages_id\`);`)
}
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  await db.run(sql`DROP TABLE \`pages_blocks_cta_whatsapp_links\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_cta\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_carousel\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_policy_policies\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_policy\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_showcase\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_two_side_with_content\`;`)
  await db.run(sql`DROP TABLE \`pages\`;`)
  await db.run(sql`DROP TABLE \`pages_rels\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_cta_whatsapp_links\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_cta\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_carousel\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_policy_policies\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_policy\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_showcase\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_two_side_with_content\`;`)
  ...
  await db.run(sql`DROP TABLE \`products_product_information\`;`)
  await db.run(sql`DROP TABLE \`products_core_instructions\`;`)
  await db.run(sql`DROP TABLE \`products_size_charts\`;`)
  await db.run(sql`DROP TABLE \`products_gallery\`;`)
  await db.run(sql`DROP TABLE \`products\`;`)
  await db.run(sql`DROP TABLE \`products_rels\`;`)
  await db.run(sql`DROP TABLE \`_products_v_version_product_information\`;`)
  await db.run(sql`DROP TABLE \`_products_v_version_core_instructions\`;`)
  await db.run(sql`DROP TABLE \`_products_v_version_size_charts\`;`)
  ...
  await db.run(sql`DROP TABLE \`footer_nav_items_items\`;`)
  await db.run(sql`DROP TABLE \`footer_nav_items\`;`)
  await db.run(sql`DROP TABLE \`footer_blocks_carousel\`;`)
  await db.run(sql`DROP TABLE \`footer_locations_address_phone_numbers\`;`)
  await db.run(sql`DROP TABLE \`footer_locations_hours\`;`)
  await db.run(sql`DROP TABLE \`footer_locations\`;`)
  await db.run(sql`DROP TABLE \`footer\`;`)
  await db.run(sql`DROP TABLE \`footer_rels\`;`)
  await db.run(sql`DROP TABLE \`social_social_links\`;`)
  await db.run(sql`DROP TABLE \`social\`;`)
  await db.run(sql`DROP TABLE \`social_rels\`;`)
}
